...
- 「有名な場所にある、あまり知られていない具体物」または「何気ない場所に隠れた意外な経緯」を優先する。場所の名前を別の観光地へ置き換えても成立する説明は採用しない
...
【内部評価】
候補を広く調査してから、「予想とのズレ」「前提知識なしで伝わるか」「理由を知った納得感」「具体的に想像できるか」「一文で話したくなるか」「場所との強い結びつき」「信頼性」を各0〜5点で評価する。
...
is_triviaは「予想とのズレがあり、一文で人に話したくなるか」、is_hyperlocalは「場所を別の地域へ置き換えられないか」、answers_why_and_howは「面白さの核心となる理由または仕組みを十分に説明したか」で判定してください。
...
def review_map_trivia_quality(
    ...
    for assessment in parsed.assessments:
        ...
        passed = (
            ...
            and assessment.hyperlocal_score >= 3
            and assessment.why_how_score >= 3
